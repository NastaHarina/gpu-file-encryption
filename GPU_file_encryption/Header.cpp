...
// Функция для ОБРАТНОГО циклического сдвига строк в матрице состояния
...
// Функция для ОБРАТНОГО перемешивания столбцов в матрице состояния
...
// Функция для инвертирования SBox
...
// Функция для дешифрования блока данных
